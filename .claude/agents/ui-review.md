...
2. Walk the primary journey first. Open the Dashboard, add an expense, read Analytics.
...
Is the Dashboard readable at a glance?
...
Do income, expense, and warning colours mean the same thing everywhere?
